...
- Patch number is automatically updated through github actions. See detailed in the `workflow file <https://github.com/tangxifan/micro_benchmark/blob/master/.github/workflows/patch_updater.yml>`_
